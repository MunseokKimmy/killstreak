...
class StatsService {
  ...
  StatsService() {
    ...
    singleGameStats.add(PlayerGameStats("Lydia", 1, "Playoffs Game 1", 1,
        "Aldair's Volleyball Group", 6424, true, 2, 2, 3, 1, 4, 1, 1, 3, 1, 3));
    singleGameStats.add(PlayerGameStats("Spencer", 1, "Playoffs Game 1", 1,
        "Aldair's Volleyball Group", 6424, true, 3, 1, 5, 1, 5, 2, 1, 1, 1, 2));
