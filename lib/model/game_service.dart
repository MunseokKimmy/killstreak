...
class GameService {
  ...
  GameService() {
    // gameShorts.add(GameShort(1, "Playoffs Game 1", "Aldair's Volleyball Group",
    //     "Jul 29, 2022", "Red", "Blue", 0, 0, true, false, false));
    // gameShorts.add(GameShort(2, "Playoffs Game 2", "Aldair's Volleyball Group",
    //     "Jul 29, 2022", "Yellow", "Green", 12, 25, true, true, true));
    // gameShorts.add(GameShort(3, "Playoffs Game 3", "RB", "Jul 29, 2022", "Grey",
    //     "Black", 25, 11, false, false, true));
    // gameShorts.add(GameShort(4, "Playoffs Game 4", "BYU Intermurals",
    //     "Jul 29, 2022", "Orange", "Brown", 18, 25, true, true, true));
    // gameShorts.add(GameShort(5, "Playoffs Game 5", "47th Ward", "Jul 29, 2022",
